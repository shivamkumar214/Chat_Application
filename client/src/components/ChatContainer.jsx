...
const ChatContainer = () => {
  ...
  return selectedUser ?  (
    ...
    <div className='h-full flex flex-col gap-5  overflow-scroll relative backdrop-blur-lg'>
        ...
        <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
            ...
            {/* ---------- Chat Area ----------- */}
        <div className='flex flex-col overflow-y-scroll p-3 pb-17'>
            {messages.map((msg, idx) => (                
                ...
                <div key={idx} className={`flex items-end gap-2 justify-end 
                    ${msg.senderId !== authUser._id && 'flex-row-reverse'}`}>
                        ...
                        {msg.image ? (
                          <img  src={msg.image} alt="" className='max-w-57 max-h-120 border
                          border-green-700 rounded-xl overflow-hidden mb-8' />
                        ): (
                            <p className={`p-2 max-w-55 md-text-sm font-light
           ...
           <div ref={scrollEnd}><hr className='w-4 h-2 border-none' /></div> 
        </div>

 
            {/* ---------- bottom Area ----------- */}
        <div className='fixed bg-gray-900 bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
    ...
    <div className='flex flex-col items-center justify-center gap-2 text-gray-500
     max-md:hidden backdrop-blur-lg '>
